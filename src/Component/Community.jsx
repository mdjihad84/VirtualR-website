...
const Community = () => {
  return (
    <div id="Community" className="px-4">
      ...
      <div className="flex justify-center">
        <div className="mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-10 mt-10">
          {[User1, User2, User3, User4, User5, User6].map((user, index) => (
            <div
              key={index}
              className="w-full max-w-[410px] h-auto bg-black rounded-md p-5 border border-[#3a3030]"
            >
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <h5 className="text-base text-white">Stellar Solutions</h5>
                </div>
              </div>
            </div>
          ))}
