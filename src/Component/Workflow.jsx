...
const Workflow = () => {
  return (
    <div id="Workflow" className="px-4 py-8 sm:px-8 lg:px-20">
      ...
      <div className="flex flex-col lg:flex-row justify-around items-center gap-10 my-10 lg:my-20">
        <div className="flex justify-center">
          <img
            className="w-full max-w-[400px] sm:max-w-[500px] lg:max-w-[653px]"
            src={CodeImg}
            alt="Code"
          />
        </div>
        <div className="flex flex-col items-start">
          ...
          <FeatureItem
            ...
            description="Integrate with your existing tools and workflows effortlessly."
          ...
          <FeatureItem
            ...
            description="Collaborate with your team for faster development."
...
const FeatureItem = ({ title, description, className }) => (
  <div className={`flex items-center ${className}`}>
    ...
    <div className="pl-5">
      <h3 className="text-base sm:text-lg md:text-xl text-white mb-2 sm:mb-3">
        {title}
      </h3>
      <p className="text-sm sm:text-base md:text-xl text-gray-300 max-w-[350px] sm:max-w-[500px] lg:max-w-[588px]">
        {description}
      </p>
    </div>
  </div>
